...
extends MemberHandle<MappingMethod> {
    ...
    public MappingMethod asMapping(boolean includeOwner) {
        if (!includeOwner) return new MappingMethod(null, this.getName(), this.getDesc());
        if (this.ownerHandle == null) return new MappingMethod(this.getOwner(), this.getName(), this.getDesc());
