...
implements IMixinContext {
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement<ExecutableElement> {
        ...
        public TypeMirror getTargetType() {
            switch (1.$SwitchMap$org$spongepowered$asm$mixin$gen$AccessorInfo$AccessorType[this.getAccessorType().ordinal()]) {
                case 1: {
        ...
        public AccessorInfo.AccessorType getAccessorType() {
            ...
            if (this.returnType.getKind() == TypeKind.VOID) {
                accessorType = AccessorInfo.AccessorType.FIELD_SETTER;
                return accessorType;
            }
            accessorType = AccessorInfo.AccessorType.FIELD_GETTER;
            return accessorType;
        }
        ...
        public String toString() {
            if (this.targetName == null) return "<invalid>";
