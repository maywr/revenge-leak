...
final class Item {
    ...
    boolean isEqualTo(Item i) {
        switch (this.type) {
            ...
            case 6: 
            case 32: {
                if (i.longVal != this.longVal) return false;
                return true;
            }
            case 3: 
            case 4: {
                if (i.intVal != this.intVal) return false;
                return true;
            }
            case 31: {
                if (i.intVal != this.intVal) return false;
                if (!i.strVal1.equals(this.strVal1)) return false;
                return true;
            }
            case 12: {
                if (!i.strVal1.equals(this.strVal1)) return false;
                if (!i.strVal2.equals(this.strVal2)) return false;
                return true;
            }
            case 18: {
                if (i.longVal != this.longVal) return false;
        ...
        if (!i.strVal1.equals(this.strVal1)) return false;
        if (!i.strVal2.equals(this.strVal2)) return false;
        if (!i.strVal3.equals(this.strVal3)) return false;
        return true;
    }
}
