...
public class InsnList {
    ...
    public AbstractInsnNode get(int index) {
        ...
        if (this.cache != null) return this.cache[index];
    ...
    public int indexOf(AbstractInsnNode insn) {
        if (this.cache != null) return insn.index;
        this.cache = this.toArray();
        return insn.index;
    }
    ...
    implements ListIterator {
        ...
        public int nextIndex() {
            ...
            if (InsnList.this.cache != null) return this.next.index;
        ...
        public int previousIndex() {
            ...
            if (InsnList.this.cache != null) return this.prev.index;
            InsnList.this.cache = InsnList.this.toArray();
