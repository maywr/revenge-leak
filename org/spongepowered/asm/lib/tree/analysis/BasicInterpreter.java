...
implements Opcodes {
        ...
        switch (insn.getOpcode()) {
            ...
            case 18: {
                ...
                if (!(cst instanceof Type)) {
                    if (!(cst instanceof Handle)) throw new IllegalArgumentException("Illegal LDC constant " + cst);
                    return this.newValue(Type.getObjectType("java/lang/invoke/MethodHandle"));
                }
                int sort = ((Type)cst).getSort();
                if (sort == 10) return this.newValue(Type.getObjectType("java/lang/Class"));
                if (sort == 9) {
                    return this.newValue(Type.getObjectType("java/lang/Class"));
                }
                if (sort != 11) throw new IllegalArgumentException("Illegal LDC constant " + cst);
    ...
    public BasicValue naryOperation(AbstractInsnNode insn, List<? extends BasicValue> values) throws AnalyzerException {
        ...
        if (opcode != 186) return this.newValue(Type.getReturnType(((MethodInsnNode)insn).desc));
