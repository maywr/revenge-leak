...
public class Frame<V extends Value> {
    ...
    public V getLocal(int i) throws IndexOutOfBoundsException {
        if (i < this.locals) return this.values[i];
    ...
    public V pop() throws IndexOutOfBoundsException {
        if (this.top != 0) return this.values[--this.top + this.locals];
    ...
    public void execute(AbstractInsnNode insn, Interpreter<V> interpreter) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 90: {
                V value1 = this.pop();
                V value2 = this.pop();
                if (value1.getSize() != 1) throw new AnalyzerException(insn, "Illegal use of DUP_X1");
                if (value2.getSize() != 1) {
            ...
            case 93: {
                ...
                if (value1.getSize() == 1) {
                    ...
                    V value3 = this.pop();
                    if (value3.getSize() != 1) throw new AnalyzerException(insn, "Illegal use of DUP2_X1");
                    this.push(interpreter.copyOperation(insn, value2));
                    this.push(interpreter.copyOperation(insn, value1));
                    this.push(value3);
                    this.push(value2);
            ...
            case 95: {
                V value2 = this.pop();
                V value1 = this.pop();
                if (value1.getSize() != 1) throw new AnalyzerException(insn, "Illegal use of SWAP");
                if (value2.getSize() != 1) {
            ...
            case 185: {
                ...
                for (int i = Type.getArgumentTypes((String)desc).length; i > 0; --i) {
