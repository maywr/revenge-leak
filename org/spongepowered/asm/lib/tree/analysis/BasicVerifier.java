...
extends BasicInterpreter {
    ...
    public BasicValue copyOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 25: {
                if (value.isReference() != false) return value;
                throw new AnalyzerException(insn, null, "an object reference", value);
            }
            case 58: {
                if (value.isReference() != false) return value;
                if (BasicValue.RETURNADDRESS_VALUE.equals(value) != false) return value;
                throw new AnalyzerException(insn, null, "an object reference or a return address", value);
            }
        }
        return value;
lbl22: // 4 sources:
        if (expected.equals(value) != false) return value;
    ...
    public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 192: {
                if (value.isReference() != false) return super.unaryOperation(insn, value);
                throw new AnalyzerException(insn, null, "an object reference", value);
            }
            case 190: {
                if (this.isArrayValue(value) != false) return super.unaryOperation(insn, value);
...
lbl30: // 6 sources:
        if (this.isSubTypeOf(value, expected) != false) return super.unaryOperation(insn, value);
        throw new AnalyzerException(insn, null, expected, value);
    }
    ...
    public BasicValue binaryOperation(AbstractInsnNode insn, BasicValue value1, BasicValue value2) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 51: {
                expected1 = this.isSubTypeOf(value1, this.newValue(Type.getType("[Z"))) != false ? this.newValue(Type.getType("[Z")) : this.newValue(Type.getType("[B"));
                expected2 = BasicValue.INT_VALUE;
                ** break;
            }
            case 52: {
...
lbl64: // 15 sources:
        ...
        if (insn.getOpcode() != 50) return super.binaryOperation(insn, value1, value2);
...
lbl35: // 8 sources:
        ...
        if (this.isSubTypeOf(value3, expected3) != false) return null;
    ...
    public BasicValue naryOperation(AbstractInsnNode insn, List<? extends BasicValue> values) throws AnalyzerException {
        ...
        if (opcode != 197) {
            ...
            do {
                if (i >= values.size()) return super.naryOperation(insn, (List)values);
                expected = this.newValue(args[j++]);
            } while (this.isSubTypeOf(encountered = values.get(i++), expected));
    ...
    public void returnOperation(AbstractInsnNode insn, BasicValue value, BasicValue expected) throws AnalyzerException {
        if (this.isSubTypeOf(value, expected)) return;
