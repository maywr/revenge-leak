...
implements IExtension {
    ...
    public void preApply(ITargetClassContext context) {
        ...
        Iterator<ClassInfo.Method> iterator = targetClassInfo.getInterfaceMethods(false).iterator();
        while (iterator.hasNext()) {
            ClassInfo.Method m = iterator.next();
    ...
    public void postApply(ITargetClassContext context) {
        ...
        Iterator<ClassInfo.Method> iterator = interfaceMethods.iterator();
        do {
            if (!iterator.hasNext()) {
                if (missingMethodCount <= 0) return;
