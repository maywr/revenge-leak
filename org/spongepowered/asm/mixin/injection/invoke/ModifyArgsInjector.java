...
extends InvokeInjector {
    ...
    private boolean verifyTarget(Target target) {
        ...
        if (this.methodNode.desc.equals(shortDesc)) return false;
        ...
        if (!this.methodNode.desc.equals(longDesc)) throw new InvalidInjectionException(this.info, "@ModifyArgs injector " + this + " has an invalid signature " + this.methodNode.desc + ", expected " + shortDesc + " or " + longDesc);
        return true;
    }
