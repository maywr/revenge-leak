...
implements Cancellable {
    ...
    public static String getCallInfoClassName(Type returnType) {
        ...
        if (returnType.equals(Type.VOID_TYPE)) {
            string = CallbackInfo.class.getName();
            return string.replace('.', '/');
        }
        string = CallbackInfoReturnable.class.getName();
        return string.replace('.', '/');
    }
    ...
    static String getConstructorDescriptor(Type returnType) {
        ...
        if (returnType.getSort() == 10 || returnType.getSort() == 9) return String.format("(%sZ%s)V", "Ljava/lang/String;", "Ljava/lang/Object;");
