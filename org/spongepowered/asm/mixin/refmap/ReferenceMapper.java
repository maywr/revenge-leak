...
Serializable {
    ...
    public String getStatus() {
        if (this.isDefault()) {
            return "No refMap loaded.";
        }
        String string = "Using refmap " + this.getResourceName();
        return string;
    }
    ...
    public String remapWithContext(String context, String className, String reference) {
        ...
        if (context == null) return this.remap(mappings, className, reference);
        mappings = this.data.get(context);
        if (mappings != null) return this.remap(mappings, className, reference);
    ...
    public String addMapping(String context, String className, String reference, String newReference) {
        ...
        if ((classMappings = mappings.get(className)) != null) return classMappings.put(reference, newReference);
