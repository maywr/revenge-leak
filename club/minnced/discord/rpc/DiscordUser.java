...
extends Structure {
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(this.userId, that.userId)) return false;
        if (!Objects.equals(this.username, that.username)) return false;
        if (!Objects.equals(this.discriminator, that.discriminator)) return false;
        if (!Objects.equals(this.avatar, that.avatar)) return false;
        return true;
    }
